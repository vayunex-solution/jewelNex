...
-- Metal Voucher Columns
ALTER TABLE Vouchers ADD COLUMN Metal TEXT;
ALTER TABLE Vouchers ADD COLUMN Weight DECIMAL(10, 3) NOT NULL DEFAULT 0;
ALTER TABLE Vouchers ADD COLUMN Purity TEXT;
ALTER TABLE Vouchers ADD COLUMN FineWeight DECIMAL(10, 3) NOT NULL DEFAULT 0;
